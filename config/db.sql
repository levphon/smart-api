...
INSERT INTO `exec_machine_history` (`id`, `task_id`, `task_name`, `machine_id`, `hostname`, `ip`, `status`, `stdout`, `stderr`, `executed_at`, `creator`, `create_by`, `update_by`, `created_at`, `updated_at`, `deleted_at`, `execution_time`)
VALUES
    (1,6,'测试任务',1,'10.50.183.112','10.50.183.112',0,'sunwenbo 测试\n','','2024-09-14 17:08:37','system',0,0,'2024-09-14 17:08:37.393','2024-09-14 17:08:37.393',NULL,0),
    (2,6,'测试任务',1,'10.50.183.112','10.50.183.112',0,'sunwenbo 测试\n','','2024-09-14 17:13:33','system',0,0,'2024-09-14 17:13:32.680','2024-09-14 17:13:32.680',NULL,0),
    (3,6,'测试任务',1,'10.50.183.112','10.50.183.112',0,'sunwenbo 测试\n','','2024-09-14 17:18:11','system',0,0,'2024-09-14 17:18:10.519','2024-09-14 17:18:10.519',NULL,0),
    (4,6,'测试任务',1,'10.50.183.112','10.50.183.112',0,'sunwenbo 测试\n','','2024-09-14 17:49:50','system',0,0,'2024-09-14 17:49:50.263','2024-09-14 17:49:50.263',NULL,0),
    (5,6,'测试任务',1,'10.50.183.112','10.50.183.112',0,'sunwenbo 测试\n','','2024-09-23 20:08:38','system',0,0,'2024-09-23 20:08:38.101','2024-09-23 20:08:38.101',NULL,0),
    (6,6,'测试任务',1,'10.50.183.112','10.50.183.112',0,'sunwenbo 测试\n','','2024-09-23 20:13:27','system',0,0,'2024-09-23 20:13:26.581','2024-09-23 20:13:26.581',NULL,0),
    (7,6,'测试任务',1,'10.50.183.112','10.50.183.112',0,'sunwenbo 测试\n','','2024-09-23 20:21:12','system',0,0,'2024-09-23 20:21:12.471','2024-09-23 20:21:12.471',NULL,0);
...
INSERT INTO `operation_history` (`id`, `title`, `node_name`, `transfer`, `remark`, `status`, `handlerId`, `handlerName`, `handleTime`, `handleDuration`, `created_at`, `updated_at`, `deleted_at`)
VALUES
    (1,'默认标题-admin-20240925102234','直属领导','更新','','closed',1,'admin','2024-10-09 15:52:35.875',0,'2024-10-09 15:52:35.876','2024-10-09 15:52:35.876',NULL);
...
VALUES
    (1,1,NULL,'1\n',14,0,'2024-09-24 18:00:02.703','2024-09-24 18:00:02.703',NULL),
    (2,1,NULL,'1',16,0,'2024-09-24 18:00:23.309','2024-09-24 18:00:23.309',NULL);
...
VALUES
    ...
    (5,'服务器权限','ServerPermission','服务器登陆权限','el-icon-s-platform',1,'/order/classify/ServerPermission',1,1,'2024-09-19 16:26:53.357','2024-10-09 15:50:28.387',NULL,'admin','admin'),
...
VALUES
    (1,'测试任务22','1','/usr/bin/python2','print \"111\"','admin','描述信息',1,1,'2024-08-17 19:57:03.929','2024-08-17 20:16:27.562','2024-09-10 17:34:54.860','admin'),
    (2,'测试任务','1','python','测试','admin','描述信息',1,0,'2024-08-17 19:57:36.483','2024-08-17 19:57:36.483','2024-08-17 20:22:40.500',NULL),
    (3,'测试任务','0','/bin/bash','#!/bin/bash\n\n# 在这里编写 shell 脚本\n\nworkOrderForm=$1 # 接受工单工单数据\n\n# 推荐使用 jq 命令来获取 Json 结构对应的键值数据。具体使用方法，还请自行百度。\n# 此外，还需注意 jq 命令，若没有还需在任务工作节点安装此命令。\n\n# ------------- 在下面编写您的业务逻辑代码 -------------\n\necho \"1111\"','admin','测试一下',1,1,'2024-08-19 16:21:22.156','2024-08-19 16:21:22.156','2024-08-19 17:48:38.232','admin'),
    (4,'python3 测试','1','/usr/bin/python3','print(\"test\")','admin','11',1,0,'2024-08-19 16:32:50.750','2024-08-19 16:32:50.750','2024-08-19 17:46:34.936',''),
    (5,'111','1','/usr/bin/python3','#!/usr/bin/env python3\n\n# 在这里编写 Python 脚本\nprint(\"task 孙文波测试\")\n# workOrderForm=$1 # 接受工单工单数据\n\n# 推荐使用 jq 命令来获取 Json 结构对应的键值数据。具体使用方法，还请自行百度。\n# 此外，还需注意 jq 命令，若没有还需在任务工作节点安装此命令。\n\n# ------------- 在下面编写您的业务逻辑代码 -------------','admin','111',1,1,'2024-08-19 19:20:39.940','2024-08-19 19:20:39.940',NULL,'admin'),
    (6,'测试任务','0','/bin/bash','#!/bin/bash\n\n# 在这里编写 shell 脚本\n\nworkOrderForm=$1 # 接受工单工单数据\n\necho \"sunwenbo 测试\"\nmkdir -p /tmp/sunwenbo\n\n# 推荐使用 jq 命令来获取 Json 结构对应的键值数据。具体使用方法，还请自行百度。\n# 此外，还需注意 jq 命令，若没有还需在任务工作节点安装此命令。\n\n# ------------- 在下面编写您的业务逻辑代码 -------------','sunwenbo','',2,2,'2024-09-10 17:34:50.094','2024-09-10 17:34:50.094',NULL,'sunwenbo');
...
VALUES
    (1,'LDAP账号注册-admin-20241014144936','运维人员','孙文波','LDAP账号注册','normal','under-way','','','{\"input67790\": \"zhangsan\", \"input67791\": \"\"}',1,0,'2024-10-14 14:49:47.361','2024-10-14 14:49:47.361',NULL,'admin','','LdapAccountRegister',2,'{\"id\": 3, \"name\": \"LDAP账号注册\", \"notice\": [2, 1, 3], \"creator\": \"admin\", \"ratings\": true, \"comments\": true, \"createBy\": 1, \"updateBy\": 0, \"createdAt\": \"2024-09-15 22:02:06\", \"structure\": {\"edges\": [{\"id\": \"flow1726408760137\", \"seq\": \"1\", \"type\": \"flow-polyline-round\", \"clazz\": \"flow\", \"label\": \"提交\", \"style\": {}, \"source\": \"start1726408739841\", \"target\": \"userTask1726408742477\", \"endPoint\": {\"x\": 382.8046875, \"y\": 75, \"index\": 3}, \"startPoint\": {\"x\": 210.3046875, \"y\": 68.5, \"index\": 1}, \"sourceAnchor\": 1, \"targetAnchor\": 3}, {\"id\": \"flow1726408765640\", \"seq\": \"4\", \"type\": \"flow-polyline-round\", \"clazz\": \"flow\", \"label\": \"处理成功\", \"style\": {}, \"source\": \"receiveTask1726408752430\", \"target\": \"end1726408758173\", \"endPoint\": {\"x\": 367.3046875, \"y\": 223, \"index\": 2}, \"startPoint\": {\"x\": 597.3046875, \"y\": 209, \"index\": 3}, \"sourceAnchor\": 3, \"targetAnchor\": 2}, {\"id\": \"flow1726408806929\", \"seq\": \"2\", \"type\": \"flow-polyline-round\", \"clazz\": \"flow\", \"label\": \"同意\", \"style\": {}, \"source\": \"userTask1726408742477\", \"target\": \"receiveTask1726408752430\", \"endPoint\": {\"x\": 637.8046875, \"y\": 186.5, \"index\": 0}, \"startPoint\": {\"x\": 463.8046875, \"y\": 75, \"index\": 1}, \"sourceAnchor\": 1, \"targetAnchor\": 0}, {\"id\": \"flow1726408835676\", \"seq\": \"3\", \"type\": \"flow-polyline-round\", \"clazz\": \"flow\", \"label\": \"拒绝\", \"style\": {}, \"source\": \"userTask1726408742477\", \"target\": \"end1726408758173\", \"endPoint\": {\"x\": 367.3046875, \"y\": 223, \"index\": 2}, \"startPoint\": {\"x\": 423.3046875, \"y\": 97.5, \"index\": 2}, \"sourceAnchor\": 2, \"targetAnchor\": 2}, {\"id\": \"flow1726408890148\", \"seq\": \"5\", \"type\": \"flow-polyline-round\", \"clazz\": \"flow\", \"label\": \"处理失败\", \"style\": {}, \"source\": \"receiveTask1726408752430\", \"target\": \"userTask1726408742477\", \"endPoint\": {\"x\": 423.3046875, \"y\": 52.5, \"index\": 0}, \"startPoint\": {\"x\": 637.8046875, \"y\": 231.5, \"index\": 2}, \"sourceAnchor\": 2, \"targetAnchor\": 0}], \"nodes\": [{\"x\": 194.8046875, \"y\": 68.5, \"id\": \"start1726408739841\", \"size\": [30, 30], \"type\": \"start-node\", \"clazz\": \"start\", \"depth\": 0, \"label\": \"发起申请\", \"shape\": \"start-node\", \"style\": {}}, {\"x\": 423.3046875, \"y\": 75, \"id\": \"userTask1726408742477\", \"size\": [80, 44], \"type\": \"user-task-node\", \"clazz\": \"userTask\", \"depth\": 0, \"label\": \"运维人员\", \"shape\": \"user-task-node\", \"style\": {}, \"assignType\": \"assignee\", \"activeOrder\": false, \"assignValue\": [2], \"isCounterSign\": false}, {\"x\": 637.8046875, \"y\": 209, \"id\": \"receiveTask1726408752430\", \"size\": [80, 44], \"task\": [\"测试任务\"], \"type\": \"receive-task-node\", \"clazz\": \"receiveTask\", \"depth\": 0, \"label\": \"处理节点\", \"shape\": \"receive-task-node\", \"style\": {}, \"machine\": [\"10.50.183.112\"], \"assignType\": \"person\", \"activeOrder\": false, \"assignValue\": [2], \"isCounterSign\": false}, {\"x\": 382.8046875, \"y\": 223, \"id\": \"end1726408758173\", \"size\": [30, 30], \"type\": \"end-node\", \"clazz\": \"end\", \"depth\": 0, \"label\": \"工单结束\", \"shape\": \"end-node\", \"style\": {}}], \"combos\": [], \"groups\": []}, \"updatedAt\": \"2024-09-15 22:02:06\", \"categoryId\": 1, \"description\": \"LDAP账号\", \"regenerator\": \"\"}');
...
VALUES
    (5,'smart-api/app/admin/apis.SysLoginLog.Get-fm','登录日志通过id获取','/api/v1/sys-login-log/:id','BUS','GET','2021-05-13 19:59:00.728','2024-08-13 21:10:18.599',NULL,0,0),
    (6,'smart-api/app/admin/apis.SysOperaLog.GetPage-fm','操作日志列表','/api/v1/sys-opera-log','BUS','GET','2021-05-13 19:59:00.778','2024-08-13 21:10:18.599',NULL,0,0),
    (7,'smart-api/app/admin/apis.SysOperaLog.Get-fm','操作日志通过id获取','/api/v1/sys-opera-log/:id','BUS','GET','2021-05-13 19:59:00.821','2024-08-13 21:10:18.599',NULL,0,0),
    (8,'smart-api/common/actions.IndexAction.func1','分类列表','/api/v1/syscategory','BUS','GET','2021-05-13 19:59:00.870','2024-08-13 21:10:18.599',NULL,0,0),
    (9,'smart-api/common/actions.ViewAction.func1','分类通过id获取','/api/v1/syscategory/:id','BUS','GET','2021-05-13 19:59:00.945','2024-08-13 21:10:18.599',NULL,0,0),
    (10,'smart-api/common/actions.IndexAction.func1','内容列表','/api/v1/syscontent','BUS','GET','2021-05-13 19:59:01.005','2024-08-13 21:10:18.599',NULL,0,0),
    (11,'smart-api/common/actions.ViewAction.func1','内容通过id获取','/api/v1/syscontent/:id','BUS','GET','2021-05-13 19:59:01.056','2024-08-13 21:10:18.599',NULL,0,0),
    (15,'smart-api/common/actions.IndexAction.func1','job列表','/api/v1/sysjob','BUS','GET','2021-05-13 19:59:01.248','2024-08-13 21:10:18.599',NULL,0,0),
    (16,'smart-api/common/actions.ViewAction.func1','job通过id获取','/api/v1/sysjob/:id','BUS','GET','2021-05-13 19:59:01.298','2024-08-13 21:10:18.599',NULL,0,0),
    (21,'smart-api/app/admin/apis.SysDictType.GetPage-fm','字典类型列表','/api/v1/dict/type','BUS','GET','2021-05-13 19:59:01.525','2024-08-13 21:10:18.599',NULL,0,0),
    (22,'smart-api/app/admin/apis.SysDictType.GetAll-fm','字典类型查询【代码生成】','/api/v1/dict/type-option-select','SYS','GET','2021-05-13 19:59:01.582','2021-06-13 20:53:48.388',NULL,0,0),
    (23,'smart-api/app/admin/apis.SysDictType.Get-fm','字典类型通过id获取','/api/v1/dict/type/:id','BUS','GET','2021-05-13 19:59:01.632','2024-08-13 21:10:18.599',NULL,0,0),
    (24,'smart-api/app/admin/apis.SysDictData.GetPage-fm','字典数据列表','/api/v1/dict/data','BUS','GET','2021-05-13 19:59:01.684','2024-08-14 16:51:38.287',NULL,0,0),
    (25,'smart-api/app/admin/apis.SysDictData.Get-fm','字典数据通过code获取','/api/v1/dict/data/:dictCode','BUS','GET','2021-05-13 19:59:01.732','2024-08-13 21:10:18.599',NULL,0,0),
    (26,'smart-api/app/admin/apis.SysDictData.GetSysDictDataAll-fm','数据字典根据key获取','/api/v1/dict-data/option-select','SYS','GET','2021-05-13 19:59:01.832','2021-06-17 11:48:40.732',NULL,0,0),
    (27,'smart-api/app/admin/apis.SysDept.GetPage-fm','部门列表','/api/v1/dept','BUS','GET','2021-05-13 19:59:01.940','2024-09-29 17:39:23.384',NULL,0,0),
    (28,'smart-api/app/admin/apis.SysDept.Get-fm','部门通过id获取','/api/v1/dept/:id','BUS','GET','2021-05-13 19:59:02.009','2024-08-13 21:10:18.599',NULL,0,0),
    (29,'smart-api/app/admin/apis.SysDept.Get2Tree-fm','查询部门下拉树【角色权限-自定权限】','/api/v1/deptTree','SYS','GET','2021-05-13 19:59:02.050','2021-06-17 11:48:40.732',NULL,0,0),
    (30,'smart-api/app/admin/apis/tools.(*Gen).GetDBTableList-fm','数据库表列表','/api/v1/db/tables/page','SYS','GET','2021-05-13 19:59:02.098','2021-06-13 20:53:48.730',NULL,0,0),
    (31,'smart-api/app/admin/apis/tools.(*Gen).GetDBColumnList-fm','数据表列列表','/api/v1/db/columns/page','SYS','GET','2021-05-13 19:59:02.140','2021-06-13 20:53:48.771',NULL,0,0),
    (32,'smart-api/app/admin/apis/tools.Gen.GenCode-fm','数据库表生成到项目','/api/v1/gen/toproject/:tableId','SYS','GET','2021-05-13 19:59:02.183','2021-06-13 20:53:48.812',NULL,0,0),
    (33,'smart-api/app/admin/apis/tools.Gen.GenMenuAndApi-fm','数据库表生成到DB','/api/v1/gen/todb/:tableId','SYS','GET','2021-05-13 19:59:02.227','2021-06-13 20:53:48.853',NULL,0,0),
    (34,'smart-api/app/admin/apis/tools.(*SysTable).GetSysTablesTree-fm','关系表数据【代码生成】','/api/v1/gen/tabletree','SYS','GET','2021-05-13 19:59:02.271','2021-06-13 20:53:48.893',NULL,0,0),
    (35,'smart-api/app/admin/apis/tools.Gen.Preview-fm','生成预览通过id获取','/api/v1/gen/preview/:tableId','SYS','GET','2021-05-13 19:59:02.315','2021-06-13 20:53:48.935',NULL,0,0),
    (36,'smart-api/app/admin/apis/tools.Gen.GenApiToFile-fm','生成api带文件','/api/v1/gen/apitofile/:tableId','SYS','GET','2021-05-13 19:59:02.357','2021-06-13 20:53:48.977',NULL,0,0),
    (37,'smart-api/app/admin/apis.System.GenerateCaptchaHandler-fm','验证码获取','/api/v1/getCaptcha','SYS','GET','2021-05-13 19:59:02.405','2021-06-13 20:53:49.020',NULL,0,0),
    (38,'smart-api/app/admin/apis.SysUser.GetInfo-fm','用户信息获取','/api/v1/getinfo','SYS','GET','2021-05-13 19:59:02.447','2021-06-13 20:53:49.065',NULL,0,0),
    (39,'smart-api/app/admin/apis.SysMenu.GetPage-fm','菜单列表','/api/v1/menu','BUS','GET','2021-05-13 19:59:02.497','2024-08-13 21:10:18.599',NULL,0,0),
    (40,'smart-api/app/admin/apis.SysMenu.GetMenuTreeSelect-fm','查询菜单下拉树结构【废弃】','/api/v1/menuTreeselect','SYS','GET','2021-05-13 19:59:02.542','2021-06-03 22:37:21.857',NULL,0,0),
    (41,'smart-api/app/admin/apis.SysMenu.Get-fm','菜单通过id获取','/api/v1/menu/:id','BUS','GET','2021-05-13 19:59:02.584','2024-08-13 21:10:18.599',NULL,0,0),
    (42,'smart-api/app/admin/apis.SysMenu.GetMenuRole-fm','角色菜单【顶部左侧菜单】','/api/v1/menurole','SYS','GET','2021-05-13 19:59:02.630','2021-06-13 20:53:49.574',NULL,0,0),
    (43,'smart-api/app/admin/apis.SysMenu.GetMenuIDS-fm','获取角色对应的菜单id数组【废弃】','/api/v1/menuids','SYS','GET','2021-05-13 19:59:02.675','2021-06-03 22:39:52.500',NULL,0,0),
    (44,'smart-api/app/admin/apis.SysRole.GetPage-fm','角色列表','/api/v1/role','BUS','GET','2021-05-13 19:59:02.720','2024-08-14 20:21:50.984',NULL,0,0),
    (45,'smart-api/app/admin/apis.SysMenu.GetMenuTreeSelect-fm','菜单权限列表【角色配菜单使用】','/api/v1/roleMenuTreeselect/:roleId','SYS','GET','2021-05-13 19:59:02.762','2021-06-17 11:48:40.732',NULL,0,0),
    (46,'smart-api/app/admin/apis.SysDept.GetDeptTreeRoleSelect-fm','角色部门结构树【自定义数据权限】','/api/v1/roleDeptTreeselect/:roleId','SYS','GET','2021-05-13 19:59:02.809','2021-06-17 11:48:40.732',NULL,0,0),
    (47,'smart-api/app/admin/apis.SysRole.Get-fm','角色通过id获取','/api/v1/role/:id','BUS','GET','2021-05-13 19:59:02.850','2024-08-13 21:10:18.599',NULL,0,0),
    (48,'github.com/smart-api-team/smart-api-core/sdk/pkg/jwtauth.(*GinJWTMiddleware).RefreshHandler-fm','刷新token','/api/v1/refresh_token','SYS','GET','2021-05-13 19:59:02.892','2021-06-13 20:53:49.278',NULL,0,0),
    (53,'smart-api/app/admin/apis.SysConfig.GetPage-fm','参数列表','/api/v1/config','BUS','GET','2021-05-13 19:59:03.116','2024-08-13 21:10:18.599',NULL,0,0),
    (54,'smart-api/app/admin/apis.SysConfig.Get-fm','参数通过id获取','/api/v1/config/:id','BUS','GET','2021-05-13 19:59:03.157','2024-08-13 21:10:18.599',NULL,0,0),
    (55,'smart-api/app/admin/apis.SysConfig.GetSysConfigByKEYForService-fm','参数通过键名搜索【基础默认配置】','/api/v1/configKey/:configKey','SYS','GET','2021-05-13 19:59:03.198','2021-06-13 20:53:49.745',NULL,0,0),
    (57,'smart-api/app/jobs/apis.SysJob.RemoveJobForService-fm','job移除','/api/v1/job/remove/:id','BUS','GET','2021-05-13 19:59:03.295','2024-08-13 21:10:18.599',NULL,0,0),
    (58,'smart-api/app/jobs/apis.SysJob.StartJobForService-fm','job启动','/api/v1/job/start/:id','BUS','GET','2021-05-13 19:59:03.339','2024-08-13 21:10:18.599',NULL,0,0),
    (59,'smart-api/app/admin/apis.SysPost.GetPage-fm','岗位列表','/api/v1/post','BUS','GET','2021-05-13 19:59:03.381','2024-08-14 17:47:19.864',NULL,0,0),
    (60,'smart-api/app/admin/apis.SysPost.Get-fm','岗位通过id获取','/api/v1/post/:id','BUS','GET','2021-05-13 19:59:03.433','2024-08-13 21:10:18.599',NULL,0,0),
    (62,'smart-api/app/admin/apis.SysConfig.GetSysConfigBySysApp-fm','系统前端参数','/api/v1/app-config','SYS','GET','2021-05-13 19:59:03.526','2021-06-13 20:53:49.994',NULL,0,0),
    (63,'smart-api/app/admin/apis.SysUser.GetProfile-fm','*用户信息获取','/api/v1/user/profile','SYS','GET','2021-05-13 19:59:03.567','2021-06-13 20:53:50.038',NULL,0,0),
    (66,'github.com/smart-api-team/smart-api-core/sdk/pkg/ws.(*Manager).WsClient-fm','链接ws【定时任务log】','/ws/:id/:channel','BUS','GET','2021-05-13 19:59:03.705','2024-08-13 21:10:18.599',NULL,0,0),
    (67,'github.com/smart-api-team/smart-api-core/sdk/pkg/ws.(*Manager).UnWsClient-fm','退出ws【定时任务log】','/wslogout/:id/:channel','BUS','GET','2021-05-13 19:59:03.756','2024-08-13 21:10:18.599',NULL,0,0),
    (68,'smart-api/common/middleware/handler.Ping','*用户基本信息','/info','SYS','GET','2021-05-13 19:59:03.800','2021-06-13 20:53:50.251',NULL,0,0),
    (72,'smart-api/common/actions.CreateAction.func1','分类创建','/api/v1/syscategory','BUS','POST','2021-05-13 19:59:03.982','2024-08-13 21:10:18.599',NULL,0,0),
    (73,'smart-api/common/actions.CreateAction.func1','内容创建','/api/v1/syscontent','BUS','POST','2021-05-13 19:59:04.027','2024-08-13 21:10:18.599',NULL,0,0),
    (76,'smart-api/common/actions.CreateAction.func1','job创建','/api/v1/sysjob','BUS','POST','2021-05-13 19:59:04.164','2024-08-13 21:10:18.599',NULL,0,0),
    (80,'smart-api/app/admin/apis.SysDictData.Insert-fm','字典数据创建','/api/v1/dict/data','BUS','POST','2021-05-13 19:59:04.347','2024-08-13 21:10:18.599',NULL,0,0),
    (81,'smart-api/app/admin/apis.SysDictType.Insert-fm','字典类型创建','/api/v1/dict/type','BUS','POST','2021-05-13 19:59:04.391','2024-08-13 21:44:39.789',NULL,0,0),
    (82,'smart-api/app/admin/apis.SysDept.Insert-fm','部门创建','/api/v1/dept','BUS','POST','2021-05-13 19:59:04.435','2024-08-13 21:10:18.599',NULL,0,0),
    (85,'github.com/smart-api-team/smart-api-core/sdk/pkg/jwtauth.(*GinJWTMiddleware).LoginHandler-fm','*登录','/api/v1/login','SYS','POST','2021-05-13 19:59:04.597','2021-06-13 20:53:50.784',NULL,0,0),
    (86,'smart-api/common/middleware/handler.LogOut','*退出','/api/v1/logout','SYS','POST','2021-05-13 19:59:04.642','2021-06-13 20:53:50.824',NULL,0,0),
    (87,'smart-api/app/admin/apis.SysConfig.Insert-fm','参数创建','/api/v1/config','BUS','POST','2021-05-13 19:59:04.685','2024-08-13 21:10:18.599',NULL,0,0),
    (88,'smart-api/app/admin/apis.SysMenu.Insert-fm','菜单创建','/api/v1/menu','BUS','POST','2021-05-13 19:59:04.777','2024-08-13 21:10:18.599',NULL,0,0),
    (89,'smart-api/app/admin/apis.SysPost.Insert-fm','岗位创建','/api/v1/post','BUS','POST','2021-05-13 19:59:04.886','2024-08-13 21:10:18.599',NULL,0,0),
    (90,'smart-api/app/admin/apis.SysRole.Insert-fm','角色创建','/api/v1/role','BUS','POST','2021-05-13 19:59:04.975','2024-08-13 21:10:18.599',NULL,0,0),
    (91,'smart-api/app/admin/apis.SysUser.InsetAvatar-fm','*用户头像编辑','/api/v1/user/avatar','SYS','POST','2021-05-13 19:59:05.058','2021-06-13 20:53:51.079',NULL,0,0),
    (92,'smart-api/app/admin/apis.SysApi.Update-fm','接口编辑','/api/v1/sys-api/:id','BUS','PUT','2021-05-13 19:59:05.122','2024-08-13 21:10:18.599',NULL,0,0),
    (95,'smart-api/common/actions.UpdateAction.func1','分类编辑','/api/v1/syscategory/:id','BUS','PUT','2021-05-13 19:59:05.255','2024-08-14 20:21:50.984',NULL,0,0),
    (96,'smart-api/common/actions.UpdateAction.func1','内容编辑','/api/v1/syscontent/:id','BUS','PUT','2021-05-13 19:59:05.299','2024-08-13 21:10:18.599',NULL,0,0),
    (97,'smart-api/common/actions.UpdateAction.func1','job编辑','/api/v1/sysjob','BUS','PUT','2021-05-13 19:59:05.343','2024-08-13 21:10:18.599',NULL,0,0),
    (101,'smart-api/app/admin/apis.SysDictData.Update-fm','字典数据编辑','/api/v1/dict/data/:dictCode','BUS','PUT','2021-05-13 19:59:05.519','2024-08-13 21:10:18.599',NULL,0,0),
    (102,'smart-api/app/admin/apis.SysDictType.Update-fm','字典类型编辑','/api/v1/dict/type/:id','BUS','PUT','2021-05-13 19:59:05.569','2024-08-13 21:10:18.599',NULL,0,0),
    (103,'smart-api/app/admin/apis.SysDept.Update-fm','部门编辑','/api/v1/dept/:id','BUS','PUT','2021-05-13 19:59:05.613','2024-08-13 21:10:18.599',NULL,0,0),
    (104,'smart-api/app/other/apis.SysFileDir.Update-fm','文件夹编辑','/api/v1/file-dir/:id','BUS','PUT','2021-05-13 19:59:05.662','2024-08-13 21:10:18.599',NULL,0,0),
    (105,'smart-api/app/other/apis.SysFileInfo.Update-fm','文件编辑','/api/v1/file-info/:id','BUS','PUT','2021-05-13 19:59:05.709','2024-08-13 21:10:18.599',NULL,0,0),
    (106,'smart-api/app/admin/apis.SysRole.Update-fm','角色编辑','/api/v1/role/:id','BUS','PUT','2021-05-13 19:59:05.752','2024-08-13 21:10:18.599',NULL,0,0),
    (107,'smart-api/app/admin/apis.SysRole.Update2DataScope-fm','角色数据权限修改','/api/v1/roledatascope','BUS','PUT','2021-05-13 19:59:05.803','2024-08-13 21:10:18.599',NULL,0,0),
    (108,'smart-api/app/admin/apis.SysConfig.Update-fm','参数编辑','/api/v1/config/:id','BUS','PUT','2021-05-13 19:59:05.848','2024-08-13 21:10:18.599',NULL,0,0),
    (109,'smart-api/app/admin/apis.SysMenu.Update-fm','编辑菜单','/api/v1/menu/:id','BUS','PUT','2021-05-13 19:59:05.891','2024-08-13 21:10:18.599',NULL,0,0),
    (110,'smart-api/app/admin/apis.SysPost.Update-fm','岗位编辑','/api/v1/post/:id','BUS','PUT','2021-05-13 19:59:05.934','2024-08-13 21:10:18.599',NULL,0,0),
    (111,'smart-api/app/admin/apis.SysUser.UpdatePwd-fm','*用户修改密码','/api/v1/user/pwd','SYS','PUT','2021-05-13 19:59:05.987','2021-06-13 20:53:51.724',NULL,0,0),
    (112,'smart-api/common/actions.DeleteAction.func1','分类删除','/api/v1/syscategory','BUS','DELETE','2021-05-13 19:59:06.030','2024-08-14 20:21:50.984',NULL,0,0),
    (113,'smart-api/common/actions.DeleteAction.func1','内容删除','/api/v1/syscontent','BUS','DELETE','2021-05-13 19:59:06.076','2024-08-13 21:10:18.599',NULL,0,0),
    (114,'smart-api/app/admin/apis.SysLoginLog.Delete-fm','登录日志删除','/api/v1/sys-login-log','BUS','DELETE','2021-05-13 19:59:06.118','2024-08-13 21:10:18.599',NULL,0,0),
    (115,'smart-api/app/admin/apis.SysOperaLog.Delete-fm','操作日志删除','/api/v1/sys-opera-log','BUS','DELETE','2021-05-13 19:59:06.162','2024-08-13 21:10:18.599',NULL,0,0),
    (116,'smart-api/common/actions.DeleteAction.func1','job删除','/api/v1/sysjob','BUS','DELETE','2021-05-13 19:59:06.206','2024-08-13 21:10:18.599',NULL,0,0),
    (117,'smart-api/app/other/apis.SysChinaAreaData.Delete-fm','行政区删除','/api/v1/sys-area-data','BUS','DELETE','2021-05-13 19:59:06.249','2024-08-13 21:10:18.599',NULL,0,0),
    (120,'smart-api/app/admin/apis.SysDictData.Delete-fm','字典数据删除','/api/v1/dict/data','BUS','DELETE','2021-05-13 19:59:06.387','2024-08-13 21:10:18.599',NULL,0,0),
    (121,'smart-api/app/admin/apis.SysDictType.Delete-fm','字典类型删除','/api/v1/dict/type','BUS','DELETE','2021-05-13 19:59:06.432','2024-08-13 21:10:18.599',NULL,0,0),
    (122,'smart-api/app/admin/apis.SysDept.Delete-fm','部门删除','/api/v1/dept/:id','BUS','DELETE','2021-05-13 19:59:06.475','2024-08-13 21:10:18.599',NULL,0,0),
    (123,'smart-api/app/other/apis.SysFileDir.Delete-fm','文件夹删除','/api/v1/file-dir/:id','BUS','DELETE','2021-05-13 19:59:06.520','2024-08-13 21:10:18.599',NULL,0,0),
    (124,'smart-api/app/other/apis.SysFileInfo.Delete-fm','文件删除','/api/v1/file-info/:id','BUS','DELETE','2021-05-13 19:59:06.566','2024-08-13 21:10:18.599',NULL,0,0),
    (125,'smart-api/app/admin/apis.SysConfig.Delete-fm','参数删除','/api/v1/config','BUS','DELETE','2021-05-13 19:59:06.612','2024-08-13 21:10:18.599',NULL,0,0),
    (126,'smart-api/app/admin/apis.SysMenu.Delete-fm','删除菜单','/api/v1/menu','BUS','DELETE','2021-05-13 19:59:06.654','2024-08-13 21:10:18.599',NULL,0,0),
    (127,'smart-api/app/admin/apis.SysPost.Delete-fm','岗位删除','/api/v1/post/:id','BUS','DELETE','2021-05-13 19:59:06.702','2024-08-13 21:10:18.599',NULL,0,0),
    (128,'smart-api/app/admin/apis.SysRole.Delete-fm','角色删除','/api/v1/role','BUS','DELETE','2021-05-13 19:59:06.746','2024-08-13 21:10:18.599',NULL,0,0),
    (131,'github.com/smart-api-team/smart-api-core/tools/transfer.Handler.func1','系统指标','/api/v1/metrics','SYS','GET','2021-05-17 22:13:55.933','2021-06-13 20:53:49.614',NULL,0,0),
    (132,'smart-api/app/other/router.registerMonitorRouter.func1','健康状态','/api/v1/health','SYS','GET','2021-05-17 22:13:56.285','2021-06-13 20:53:49.951',NULL,0,0),
    (133,'smart-api/app/admin/apis.HelloWorld','项目默认接口','/','SYS','GET','2021-05-24 10:30:44.553','2021-06-13 20:53:47.406',NULL,0,0),
    (134,'smart-api/app/other/apis.ServerMonitor.ServerInfo-fm','服务器基本状态','/api/v1/server-monitor','SYS','GET','2021-05-24 10:30:44.937','2021-06-13 20:53:48.255',NULL,0,0),
    (135,'smart-api/app/admin/apis.SysApi.GetPage-fm','接口列表','/api/v1/sys-api','BUS','GET','2021-05-24 11:37:53.303','2024-08-13 21:10:18.599',NULL,0,0),
    (136,'smart-api/app/admin/apis.SysApi.Get-fm','接口通过id获取','/api/v1/sys-api/:id','BUS','GET','2021-05-24 11:37:53.359','2024-08-13 21:10:18.599',NULL,0,0),
    (137,'smart-api/app/admin/apis.SysLoginLog.GetPage-fm','登录日志列表','/api/v1/sys-login-log','BUS','GET','2021-05-24 11:47:30.397','2024-08-13 21:10:18.599',NULL,0,0),
    (138,'smart-api/app/other/apis.File.UploadFile-fm','文件上传','/api/v1/public/uploadFile','SYS','POST','2021-05-25 19:16:18.493','2021-06-13 20:53:50.866',NULL,0,0),
    (139,'smart-api/app/admin/apis.SysConfig.Update2Set-fm','参数信息修改【参数配置】','/api/v1/set-config','BUS','PUT','2021-05-27 09:45:14.853','2024-08-13 21:10:18.599',NULL,0,0),
    (140,'smart-api/app/admin/apis.SysConfig.Get2Set-fm','参数获取全部【配置使用】','/api/v1/set-config','BUS','GET','2021-05-27 11:54:14.384','2024-08-13 21:10:18.599',NULL,0,0),
    (141,'smart-api/app/admin/apis.SysUser.GetPage-fm','管理员列表','/api/v1/sys-user','BUS','GET','2021-06-13 19:24:57.111','2024-09-29 17:39:23.384',NULL,0,0),
    (142,'smart-api/app/admin/apis.SysUser.Get-fm','管理员通过id获取','/api/v1/sys-user/:id','BUS','GET','2021-06-13 19:24:57.188','2024-08-13 21:10:18.599',NULL,0,0),
    (143,'smart-api/app/admin/apis/tools.(*SysTable).GetSysTablesInfo-fm','','/api/v1/sys/tables/info','','GET','2021-06-13 19:24:57.437','2021-06-13 20:53:48.047',NULL,0,0),
    (144,'smart-api/app/admin/apis/tools.(*SysTable).GetSysTables-fm','','/api/v1/sys/tables/info/:tableId','','GET','2021-06-13 19:24:57.510','2021-06-13 20:53:48.088',NULL,0,0),
    (145,'smart-api/app/admin/apis/tools.(*SysTable).GetSysTableList-fm','','/api/v1/sys/tables/page','','GET','2021-06-13 19:24:57.582','2021-06-13 20:53:48.128',NULL,0,0),
    ...
    (149,'smart-api/app/admin/apis/tools.(*SysTable).InsertSysTable-fm','','/api/v1/sys/tables/info','','POST','2021-06-13 19:25:00.163','2021-06-13 20:53:50.539',NULL,0,0),
    (150,'smart-api/app/admin/apis.SysUser.Insert-fm','管理员创建','/api/v1/sys-user','BUS','POST','2021-06-13 19:25:00.233','2024-08-13 21:10:18.599',NULL,0,0),
    (151,'smart-api/app/admin/apis.SysUser.Update-fm','管理员编辑','/api/v1/sys-user','BUS','PUT','2021-06-13 19:25:00.986','2024-08-13 21:10:18.599',NULL,0,0),
    (152,'smart-api/app/admin/apis/tools.(*SysTable).UpdateSysTable-fm','','/api/v1/sys/tables/info','','PUT','2021-06-13 19:25:01.149','2021-06-13 20:53:51.375',NULL,0,0),
    (153,'smart-api/app/admin/apis.SysRole.Update2Status-fm','更新角色状态','/api/v1/role-status','BUS','PUT','2021-06-13 19:25:01.446','2024-08-13 21:10:18.599',NULL,0,0),
    (154,'smart-api/app/admin/apis.SysUser.ResetPwd-fm','重置用户密码','/api/v1/user/pwd/reset','BUS','PUT','2021-06-13 19:25:01.601','2024-08-13 21:10:18.599',NULL,0,0),
    (155,'smart-api/app/admin/apis.SysUser.UpdateStatus-fm','更新用户状态','/api/v1/user/status','BUS','PUT','2021-06-13 19:25:01.671','2024-08-13 21:10:18.599',NULL,0,0),
    (156,'smart-api/app/admin/apis.SysUser.Delete-fm','管理员删除','/api/v1/sys-user','BUS','DELETE','2021-06-13 19:25:02.043','2024-08-13 21:10:18.599',NULL,0,0),
    (157,'smart-api/app/admin/apis/tools.(*SysTable).DeleteSysTables-fm','','/api/v1/sys/tables/info/:tableId','','DELETE','2021-06-13 19:25:02.283','2021-06-13 20:53:52.367',NULL,0,0),
    ...
    (160,'smart-api/app/admin/apis.System.GenerateCaptchaHandler-fm','验证码','/api/v1/captcha','SYS','GET','2024-07-08 16:17:04.505','2024-08-13 11:40:14.526',NULL,0,0),
    ...
    (162,'smart-api/app/admin/apis.SysUser.UpdatePwd-fm','用户密码设置','/api/v1/user/pwd/set','BUS','PUT','2024-07-08 16:17:04.528','2024-08-13 21:10:18.599',NULL,0,0),
    (163,'smart-api/app/admin/apis.SysDept.Delete-fm','删除部门','/api/v1/dept','BUS','DELETE','2024-07-08 16:17:04.532','2024-08-13 21:10:18.599',NULL,0,0),
    (164,'smart-api/app/admin/apis.SysPost.Delete-fm','删除岗位','/api/v1/post','BUS','DELETE','2024-07-08 16:17:04.534','2024-08-13 21:10:18.599',NULL,0,0),
    (225,'github.com/smart-api-team/smart-api-core/sdk/pkg/jwtauth.(*GinJWTMiddleware).LoginHandler-fm','ldap用户登陆','/api/v1/ldap/login','SYS','POST','2024-08-11 17:16:07.037','2024-08-13 12:21:43.105',NULL,0,0),
    (229,'smart-api/app/system/apis.SysNotify.NotifySend-fm','发送飞书通知消息','/api/v1/notify','SYS','POST','2024-08-16 14:14:01.595','2024-08-17 17:29:37.148',NULL,0,0),
    (230,'smart-api/app/system/apis.SysUser.GetSpecify-fm','根据用户名获取指定用户信息','/api/v1/sys-user/specify-user','SYS','GET','2024-08-17 17:41:34.158','2024-08-17 17:44:51.421',NULL,0,0),
    ...
    (244,'smart-api/app/smart/apis.OrderWorks.GetPage-fm','获取工单列表','/api/v1/order-works','BUS','GET','2024-09-02 11:37:58.114','2024-09-29 17:39:23.384',NULL,0,0),
    (245,'smart-api/app/smart/apis.OrderWorks.MyBacklogGet-fm','工单列表我的待办','/api/v1/order-works/myBacklog','BUS','GET','2024-09-02 11:37:58.123','2024-09-29 17:39:23.384',NULL,0,0),
    (246,'smart-api/app/smart/apis.OrderWorks.CreatedByMe-fm','工单列表我的创建','/api/v1/order-works/createdByMe','BUS','GET','2024-09-02 11:37:58.127','2024-09-29 17:39:23.384',NULL,0,0),
    (247,'smart-api/app/smart/apis.OrderWorks.RelatedToMe-fm','工单列表与我相关','/api/v1/order-works/relatedToMe','BUS','GET','2024-09-02 11:37:58.133','2024-09-29 17:39:23.384',NULL,0,0),
    (248,'smart-api/app/smart/apis.OperationHistory.GetOperationHistory-fm','工单历史记录','/api/v1/order-works/history','BUS','GET','2024-09-02 11:37:58.137','2024-09-29 17:39:23.384',NULL,0,0),
    (249,'smart-api/app/smart/apis.WorksNotify.GetNotify-fm','系统通知','/api/v1/order-works/notify','BUS','GET','2024-09-02 11:37:58.139','2024-09-29 17:39:23.384',NULL,0,0),
    (250,'smart-api/app/smart/apis.OrderWorks.Get-fm','根据id查询工单','/api/v1/order-works/:id','BUS','GET','2024-09-02 11:37:58.140','2024-09-29 17:39:23.384',NULL,0,0),
    (251,'smart-api/app/smart/apis.OrderCategory.GetPage-fm','工单分类列表','/api/v1/order-category','BUS','GET','2024-09-02 11:37:58.142','2024-09-29 17:39:23.384',NULL,0,0),
    (252,'smart-api/app/smart/apis.OrderCategory.Get-fm','根据id查询工单分类','/api/v1/order-category/:id','BUS','GET','2024-09-02 11:37:58.144','2024-09-08 16:23:59.815',NULL,0,0),
    (253,'smart-api/app/smart/apis.OrderItems.GetPage-fm','获取工单项目列表','/api/v1/order-items','BUS','GET','2024-09-02 11:37:58.146','2024-09-29 17:39:23.384',NULL,0,0),
    (254,'smart-api/app/smart/apis.OrderItems.Get-fm','根据id获取工单项目','/api/v1/order-items/:id','BUS','GET','2024-09-02 11:37:58.147','2024-09-08 16:23:59.815',NULL,0,0),
    (255,'smart-api/app/smart/apis.OrderTask.GetPage-fm','工单任务列表','/api/v1/order-task','BUS','GET','2024-09-02 11:37:58.149','2024-09-29 17:39:23.384',NULL,0,0),
    (256,'smart-api/app/smart/apis.OrderTask.Get-fm','根据id查询工单任务','/api/v1/order-task/:id','BUS','GET','2024-09-02 11:37:58.150','2024-09-29 17:39:23.384',NULL,0,0),
    (257,'smart-api/app/smart/apis.FlowManage.GetPage-fm','工单流程管理列表','/api/v1/flow-manage','BUS','GET','2024-09-02 11:37:58.158','2024-09-08 16:20:18.821',NULL,0,0),
    (258,'smart-api/app/smart/apis.FlowManage.Get-fm','根据id查询流程','/api/v1/flow-manage/:id','BUS','GET','2024-09-02 11:37:58.160','2024-09-08 16:23:39.672',NULL,0,0),
    (259,'smart-api/app/smart/apis.FlowTemplates.GetPage-fm','工单模板列表','/api/v1/flow-templates','BUS','GET','2024-09-02 11:37:58.162','2024-09-29 17:39:23.384',NULL,0,0),
    (260,'smart-api/app/smart/apis.FlowTemplates.Get-fm','根据id获取工单模板数据	','/api/v1/flow-templates/:id','BUS','GET','2024-09-02 11:37:58.164','2024-09-08 16:23:24.404',NULL,0,0),
    (261,'smart-api/app/smart/apis.ExecMachine.GetPage-fm','执行节点列表','/api/v1/exec-machine','BUS','GET','2024-09-02 11:37:58.168','2024-09-08 15:53:16.464',NULL,0,0),
    (262,'smart-api/app/smart/apis.ExecMachine.Get-fm','根据id查询执行节点','/api/v1/exec-machine/:id','BUS','GET','2024-09-02 11:37:58.169','2024-09-08 15:53:30.896',NULL,0,0),
    (263,'smart-api/app/smart/apis.OrderWorks.Insert-fm','新建工单','/api/v1/order-works','BUS','POST','2024-09-02 11:37:58.178','2024-09-29 17:39:23.384',NULL,0,0),
    (264,'smart-api/app/smart/apis.WorksNotify.CreateNotify-fm','创建通知消息','/api/v1/order-works/notify','BUS','POST','2024-09-02 11:37:58.179','2024-09-29 17:39:23.384',NULL,0,0),
    (265,'smart-api/app/smart/apis.OrderCategory.Insert-fm','创建工单分类','/api/v1/order-category','BUS','POST','2024-09-02 11:37:58.181','2024-09-08 16:19:25.627',NULL,0,0),
    (266,'smart-api/app/smart/apis.OrderItems.Insert-fm','新建工单项目','/api/v1/order-items','BUS','POST','2024-09-02 11:37:58.183','2024-09-08 16:24:23.202',NULL,0,0),
    (267,'smart-api/app/smart/apis.OrderTask.Insert-fm','创建工单任务','/api/v1/order-task','BUS','POST','2024-09-02 11:37:58.185','2024-09-29 17:39:23.384',NULL,0,0),
    (268,'smart-api/app/smart/apis.FlowManage.Insert-fm','创建工单流程','/api/v1/flow-manage','BUS','POST','2024-09-02 11:37:58.187','2024-09-08 16:20:29.403',NULL,0,0),
    (269,'smart-api/app/smart/apis.FlowManage.Clone-fm','克隆工单流程','/api/v1/flow-manage/:id','BUS','POST','2024-09-02 11:37:58.189','2024-09-08 16:21:00.032',NULL,0,0),
    (270,'smart-api/app/smart/apis.FlowTemplates.Insert-fm','创建工单模板','/api/v1/flow-templates','BUS','POST','2024-09-02 11:37:58.191','2024-09-08 16:21:39.897',NULL,0,0),
    (271,'smart-api/app/smart/apis.ExecMachine.Insert-fm','创建执行节点','/api/v1/exec-machine','BUS','POST','2024-09-02 11:37:58.197','2024-09-08 15:54:21.248',NULL,0,0),
    (272,'smart-api/app/smart/apis.(*ExecMachine).TestConnection-fm','测试连接执行节点','/api/v1/exec-machine/testConnection','BUS','POST','2024-09-02 11:37:58.198','2024-09-08 15:53:54.510',NULL,0,0),
    (273,'smart-api/app/smart/apis.OrderWorks.Update-fm','更新工单','/api/v1/order-works','BUS','PUT','2024-09-02 11:37:58.207','2024-09-29 17:39:23.384',NULL,0,0),
    (274,'smart-api/app/smart/apis.OrderWorks.Handle-fm','处理工单','/api/v1/order-works/handle','BUS','PUT','2024-09-02 11:37:58.212','2024-09-29 17:39:23.384',NULL,0,0),
    (275,'smart-api/app/smart/apis.WorksNotify.UpdateNotify-fm','处理通知消息','/api/v1/order-works/notify','BUS','PUT','2024-09-02 11:37:58.215','2024-09-29 17:39:23.384',NULL,0,0),
    (276,'smart-api/app/smart/apis.OrderCategory.Update-fm','更新工单分类','/api/v1/order-category','BUS','PUT','2024-09-02 11:37:58.217','2024-09-08 16:19:57.195',NULL,0,0),
    (277,'smart-api/app/smart/apis.OrderItems.Update-fm','更新工单项目','/api/v1/order-items','BUS','PUT','2024-09-02 11:37:58.219','2024-09-08 16:07:16.325',NULL,0,0),
    (278,'smart-api/app/smart/apis.OrderTask.Update-fm','更新工单任务','/api/v1/order-task','BUS','PUT','2024-09-02 11:37:58.221','2024-09-29 17:39:23.384',NULL,0,0),
    (279,'smart-api/app/smart/apis.FlowManage.Update-fm','更新流程管理','/api/v1/flow-manage','BUS','PUT','2024-09-02 11:37:58.233','2024-09-08 16:20:43.772',NULL,0,0),
    (280,'smart-api/app/smart/apis.FlowTemplates.Update-fm','更新工单模板','/api/v1/flow-templates','BUS','PUT','2024-09-02 11:37:58.235','2024-09-08 16:21:46.311',NULL,0,0),
    (281,'smart-api/app/smart/apis.ExecMachine.Update-fm','更新执行节点','/api/v1/exec-machine','BUS','PUT','2024-09-02 11:37:58.236','2024-09-08 15:54:07.100',NULL,0,0),
    (282,'smart-api/app/smart/apis.OrderCategory.Delete-fm','删除工单分类','/api/v1/order-category','BUS','DELETE','2024-09-02 11:37:58.242','2024-09-08 16:19:46.850',NULL,0,0),
    (283,'smart-api/app/smart/apis.OrderItems.Delete-fm','删除工单项目','/api/v1/order-items','BUS','DELETE','2024-09-02 11:37:58.243','2024-09-08 16:07:24.286',NULL,0,0),
    (284,'smart-api/app/smart/apis.OrderTask.Delete-fm','删除工单任务','/api/v1/order-task','BUS','DELETE','2024-09-02 11:37:58.245','2024-09-29 17:39:23.384',NULL,0,0),
    (285,'smart-api/app/smart/apis.OrderWorks.Delete-fm','关闭工单','/api/v1/order-works','BUS','DELETE','2024-09-02 11:37:58.246','2024-09-08 15:59:32.750',NULL,0,0),
    (286,'smart-api/app/smart/apis.FlowManage.Delete-fm','删除工单流程','/api/v1/flow-manage','BUS','DELETE','2024-09-02 11:37:58.249','2024-09-08 16:20:53.283',NULL,0,0),
    (287,'smart-api/app/smart/apis.FlowTemplates.Delete-fm','删除工单模板','/api/v1/flow-templates','BUS','DELETE','2024-09-02 11:37:58.251','2024-09-08 16:21:53.786',NULL,0,0),
    (288,'smart-api/app/smart/apis.ExecMachine.Delete-fm','删除执行节点','/api/v1/exec-machine','BUS','DELETE','2024-09-02 11:37:58.253','2024-09-08 15:54:13.902',NULL,0,0),
    (289,'smart-api/app/system/apis.SysApi.DeleteSysApi-fm','更新接口','/api/v1/sys-api','','PUT','2024-09-08 15:40:00.260','2024-09-08 15:40:00.260',NULL,0,0),
    (290,'smart-api/app/system/apis.SysApi.DeleteSysApi-fm','删除接口','/api/v1/sys-api','','DELETE','2024-09-08 15:42:00.584','2024-09-08 15:42:00.584',NULL,0,0),
    (291,'smart-api/app/smart/apis.ExecutionHistory.GetHistoryTaskPage-fm','','/api/v1/exec-machine/history','','GET','2024-09-12 11:39:31.010','2024-09-12 11:39:31.010',NULL,0,0),
    (292,'smart-api/app/smart/apis.WebSocketAPI.WebSocketHandler-fm','','/api/v1/order-works/ws/exec','','GET','2024-09-12 17:36:24.754','2024-09-12 17:36:24.754',NULL,0,0),
    (293,'smart-api/app/smart/apis.WebSocketAPI.WebSocketHandler-fm','','/api/v1/order-works/ws/exec-task','','GET','2024-09-12 19:06:52.563','2024-09-12 19:06:52.563',NULL,0,0),
    (294,'smart-api/app/system/apis.GoAdmin','','/ws/task','','GET','2024-09-13 14:26:32.848','2024-09-13 14:26:32.848',NULL,0,0),
    (295,'smart-api/common/utils.WsHandler','','/api/v1/ws/:id/task','','GET','2024-09-13 14:56:55.550','2024-09-13 14:56:55.550',NULL,0,0),
    (296,'smart-api/common/utils.WsHandler','','/api/v1/api/v1/ws/task/:id','','GET','2024-09-14 14:57:53.781','2024-09-14 14:57:53.781',NULL,0,0),
    (297,'smart-api/common/utils.WsHandler','','/api/v1/ws/task/:id','','GET','2024-09-14 15:23:20.312','2024-09-14 15:23:20.312',NULL,0,0),
    (298,'smart-api/app/smart/apis.ExecutionHistory.Delete-fm','','/api/v1/exec-machine/history','','DELETE','2024-09-19 16:21:35.460','2024-09-19 16:21:35.460',NULL,0,0),
    (301,'smart-api/app/smart/apis.OrderRatingAPI.Insert-fm','新增工单评价','/api/v1/order-ratings','BUS','POST','2024-09-23 17:41:13.101','2024-09-29 17:39:23.384',NULL,0,0),
    (308,'smart-api/app/smart/apis.OrderRatingAPI.Update-fm','更新工单评价','/api/v1/order-ratings','BUS','PUT','2024-09-23 18:02:46.843','2024-09-29 17:39:23.384',NULL,0,0),
    (309,'smart-api/app/smart/apis.OrderRatingAPI.Delete-fm','删除工单评价','/api/v1/order-ratings','BUS','DELETE','2024-09-23 18:05:42.609','2024-09-29 17:39:23.384',NULL,0,0),
    (310,'smart-api/app/smart/apis.OrderCommentAPI.Insert-fm','新增工单留言','/api/v1/order-comments','BUS','POST','2024-09-23 18:18:09.642','2024-09-29 17:39:23.384',NULL,0,0),
    (311,'smart-api/app/smart/apis.OrderCommentAPI.Update-fm','更新工单留言','/api/v1/order-comments','BUS','PUT','2024-09-23 18:18:09.655','2024-09-29 17:39:23.384',NULL,0,0),
    (312,'smart-api/app/smart/apis.OrderCommentAPI.Delete-fm','删除工单留言','/api/v1/order-comments','BUS','DELETE','2024-09-23 18:18:09.662','2024-09-29 17:39:23.384',NULL,0,0),
    (314,'smart-api/app/smart/apis.OrderCommentAPI.Get-fm','根据工单ID获取工单留言','/api/v1/order-comments/:orderID','BUS','GET','2024-09-23 18:24:10.989','2024-09-29 17:39:23.384',NULL,0,0),
    (315,'smart-api/app/smart/apis.OrderRatingAPI.Get-fm','获取工单评价','/api/v1/order-ratings/:orderID','BUS','GET','2024-09-24 11:03:13.995','2024-09-29 17:39:23.384',NULL,0,0),
    (316,'smart-api/app/smart/apis.OrderStatistics.GetOrderStatistics-fm','获取统计工单数据','/api/v1/statistics/orders','BUS','GET','2024-09-25 17:01:25.826','2024-09-26 17:48:54.310',NULL,0,0),
    (317,'smart-api/app/smart/apis.OrderStatistics.GetOrderCountByPeriod-fm','获取统计工单折线图数据','/api/v1/statistics/orders/count','BUS','GET','2024-09-25 17:01:25.831','2024-09-26 17:49:15.676',NULL,0,0),
    (318,'smart-api/app/smart/apis.OrderStatistics.GetOrderRatings-fm','获取统计评分柱状图数据','/api/v1/statistics/ratings','BUS','GET','2024-09-25 18:30:44.327','2024-09-26 17:49:30.387',NULL,0,0),
    (322,'smart-api/app/smart/apis.UserFavorite.GetUserFavorites-fm','获取收藏的工单','/api/v1/favorite','BUS','GET','2024-09-29 15:24:18.864','2024-09-29 17:39:23.384',NULL,0,0),
    (323,'smart-api/app/smart/apis.UserFavorite.AddFavorite-fm','添加收藏的工单','/api/v1/favorite','BUS','POST','2024-09-29 15:24:18.880','2024-09-29 17:39:23.384',NULL,0,0),
    (324,'smart-api/app/smart/apis.UserFavorite.RemoveFavorite-fm','取消收藏的工单','/api/v1/favorite','BUS','DELETE','2024-09-29 15:24:18.902','2024-09-29 17:39:23.384',NULL,0,0);
...
VALUES
    (2,'Admin','系统管理','api-server','/admin','/0/2','M','无','',0,1,'','Layout',10,'0','1',0,1,'2021-05-20 21:58:45.679','2024-07-08 16:15:45.712',NULL),
    (3,'SysUserManage','用户管理','user','/admin/sys-user','/0/2/3','C','无','admin:sysUser:list',2,0,'','/admin/sys-user/index',10,'0','1',0,1,'2021-05-20 22:08:44.526','2024-07-08 16:15:45.716',NULL),
    (43,'','新增管理员','app-group-fill','','/0/2/3/43','F','POST','admin:sysUser:add',3,0,'','',10,'0','1',0,1,'2021-05-20 22:08:44.526','2024-07-08 16:15:45.722',NULL),
    (44,'','查询管理员','app-group-fill','','/0/2/3/44','F','GET','admin:sysUser:query',3,0,'','',40,'0','1',0,1,'2021-05-20 22:08:44.526','2024-07-08 16:15:45.722',NULL),
    (45,'','修改管理员','app-group-fill','','/0/2/3/45','F','PUT','admin:sysUser:edit',3,0,'','',30,'0','1',0,1,'2021-05-20 22:08:44.526','2024-07-08 16:15:45.723',NULL),
    (46,'','删除管理员','app-group-fill','','/0/2/3/46','F','DELETE','admin:sysUser:remove',3,0,'','',20,'0','1',0,1,'2021-05-20 22:08:44.526','2024-07-08 16:15:45.724',NULL),
    (51,'SysMenuManage','菜单管理','tree-table','/admin/sys-menu','/0/2/51','C','无','admin:sysMenu:list',2,1,'','/admin/sys-menu/index',30,'0','1',0,1,'2021-05-20 22:08:44.526','2024-07-08 16:15:45.716',NULL),
    (52,'SysRoleManage','角色管理','peoples','/admin/sys-role','/0/2/52','C','无','admin:sysRole:list',2,1,'','/admin/sys-role/index',20,'0','1',0,1,'2021-05-20 22:08:44.526','2024-07-08 16:15:45.717',NULL),
    (56,'SysDeptManage','部门管理','tree','/admin/sys-dept','/0/2/56','C','无','admin:sysDept:list',2,0,'','/admin/sys-dept/index',40,'0','1',0,1,'2021-05-20 22:08:44.526','2024-07-08 16:15:45.718',NULL),
    (57,'SysPostManage','岗位管理','pass','/admin/sys-post','/0/2/57','C','无','admin:sysPost:list',2,0,'','/admin/sys-post/index',50,'0','1',0,1,'2021-05-20 22:08:44.526','2024-07-08 16:15:45.718',NULL),
    (58,'Dict','字典管理','education','/admin/dict','/0/2/58','C','无','admin:sysDictType:list',2,0,'','/admin/dict/index',60,'0','1',0,1,'2021-05-20 22:08:44.526','2024-07-08 16:15:45.719',NULL),
    (59,'SysDictDataManage','字典数据','education','/admin/dict/data/:dictId','/0/2/59','C','无','admin:sysDictData:list',2,0,'','/admin/dict/data',100,'0','1',0,1,'2021-05-20 22:08:44.526','2024-08-14 16:51:38.290',NULL),
    (60,'Tools','开发工具','dev-tools','/dev-tools','/0/60','M','无','',0,0,'','Layout',40,'0','1',1,1,'2020-04-11 15:52:48.000','2024-07-08 16:15:45.713',NULL),
    (61,'Swagger','系统接口','guide','/dev-tools/swagger','/0/60/61','C','无','',60,0,'','/dev-tools/swagger/index',1,'0','1',1,1,'2020-04-11 15:52:48.000','2024-07-08 16:15:45.735',NULL),
    (62,'SysConfigManage','参数管理','swagger','/admin/sys-config','/0/2/62','C','无','admin:sysConfig:list',2,0,'','/admin/sys-config/index',70,'0','1',0,1,'2021-05-20 22:08:44.526','2024-07-08 16:15:45.720',NULL),
    (211,'Log','日志管理','log','/log','/0/2/211','M','','',2,0,'','/log/index',80,'0','1',0,1,'2021-05-20 22:08:44.526','2024-07-08 16:15:45.720',NULL),
    (212,'SysLoginLogManage','登录日志','logininfor','/admin/sys-login-log','/0/2/211/212','C','','admin:sysLoginLog:list',211,0,'','/admin/sys-login-log/index',1,'0','1',0,1,'2021-05-20 22:08:44.526','2024-07-08 16:15:45.739',NULL),
    (216,'OperLog','操作日志','skill','/admin/sys-oper-log','/0/2/211/216','C','','admin:sysOperLog:list',211,0,'','/admin/sys-oper-log/index',1,'0','1',0,1,'2021-05-20 22:08:44.526','2024-07-08 16:15:45.739',NULL),
    (220,'','新增菜单','app-group-fill','','/0/2/51/220','F','','admin:sysMenu:add',51,0,'','',1,'0','1',1,1,'2020-04-11 15:52:48.000','2024-07-08 16:15:45.724',NULL),
    (221,'','修改菜单','app-group-fill','','/0/2/51/221','F','','admin:sysMenu:edit',51,0,'','',1,'0','1',1,1,'2020-04-11 15:52:48.000','2024-07-08 16:15:45.725',NULL),
    (222,'','查询菜单','app-group-fill','','/0/2/51/222','F','','admin:sysMenu:query',51,0,'','',1,'0','1',1,1,'2020-04-11 15:52:48.000','2024-07-08 16:15:45.725',NULL),
    (223,'','删除菜单','app-group-fill','','/0/2/51/223','F','','admin:sysMenu:remove',51,0,'','',1,'0','1',1,1,'2020-04-11 15:52:48.000','2024-07-08 16:15:45.726',NULL),
    (224,'','新增角色','app-group-fill','','/0/2/52/224','F','','admin:sysRole:add',52,0,'','',1,'0','1',1,1,'2020-04-11 15:52:48.000','2024-07-08 16:15:45.726',NULL),
    (225,'','查询角色','app-group-fill','','/0/2/52/225','F','','admin:sysRole:query',52,0,'','',1,'0','1',1,1,'2020-04-11 15:52:48.000','2024-07-08 16:15:45.727',NULL),
    (226,'','修改角色','app-group-fill','','/0/2/52/226','F','','admin:sysRole:update',52,0,'','',1,'0','1',1,1,'2020-04-11 15:52:48.000','2024-07-08 16:15:45.727',NULL),
    (227,'','删除角色','app-group-fill','','/0/2/52/227','F','','admin:sysRole:remove',52,0,'','',1,'0','1',1,1,'2020-04-11 15:52:48.000','2024-07-08 16:15:45.727',NULL),
    (228,'','查询部门','app-group-fill','','/0/2/56/228','F','','admin:sysDept:query',56,0,'','',40,'0','1',0,1,'2021-05-20 22:08:44.526','2024-07-08 16:15:45.728',NULL),
    (229,'','新增部门','app-group-fill','','/0/2/56/229','F','','admin:sysDept:add',56,0,'','',10,'0','1',0,1,'2021-05-20 22:08:44.526','2024-07-08 16:15:45.728',NULL),
    (230,'','修改部门','app-group-fill','','/0/2/56/230','F','','admin:sysDept:edit',56,0,'','',30,'0','1',0,1,'2021-05-20 22:08:44.526','2024-07-08 16:15:45.729',NULL),
    (231,'','删除部门','app-group-fill','','/0/2/56/231','F','','admin:sysDept:remove',56,0,'','',20,'0','1',0,1,'2021-05-20 22:08:44.526','2024-07-08 16:15:45.729',NULL),
    (232,'','查询岗位','app-group-fill','','/0/2/57/232','F','','admin:sysPost:query',57,0,'','',0,'0','1',1,1,'2020-04-11 15:52:48.000','2024-08-14 17:47:19.857',NULL),
    (233,'','新增岗位','app-group-fill','','/0/2/57/233','F','','admin:sysPost:add',57,0,'','',0,'0','1',1,1,'2020-04-11 15:52:48.000','2024-07-08 16:15:45.730',NULL),
    (234,'','修改岗位','app-group-fill','','/0/2/57/234','F','','admin:sysPost:edit',57,0,'','',0,'0','1',1,1,'2020-04-11 15:52:48.000','2024-07-08 16:15:45.731',NULL),
    (235,'','删除岗位','app-group-fill','','/0/2/57/235','F','','admin:sysPost:remove',57,0,'','',0,'0','1',1,1,'2020-04-11 15:52:48.000','2024-07-08 16:15:45.731',NULL),
    (236,'','查询字典','app-group-fill','','/0/2/58/236','F','','admin:sysDictType:query',58,0,'','',0,'0','1',1,1,'2020-04-11 15:52:48.000','2024-07-08 16:15:45.731',NULL),
    (237,'','新增类型','app-group-fill','','/0/2/58/237','F','','admin:sysDictType:add',58,0,'','',0,'0','1',1,1,'2020-04-11 15:52:48.000','2024-07-08 16:15:45.732',NULL),
    (238,'','修改类型','app-group-fill','','/0/2/58/238','F','','admin:sysDictType:edit',58,0,'','',0,'0','1',1,1,'2020-04-11 15:52:48.000','2024-07-08 16:15:45.732',NULL),
    (239,'','删除类型','app-group-fill','','/0/2/58/239','F','','system:sysdicttype:remove',58,0,'','',0,'0','1',1,1,'2020-04-11 15:52:48.000','2024-07-08 16:15:45.733',NULL),
    (240,'','查询数据','app-group-fill','','/0/2/59/240','F','','admin:sysDictData:query',59,0,'','',0,'0','1',1,1,'2020-04-11 15:52:48.000','2024-08-14 16:51:38.291',NULL),
    (241,'','新增数据','app-group-fill','','/0/2/59/241','F','','admin:sysDictData:add',59,0,'','',0,'0','1',1,1,'2020-04-11 15:52:48.000','2024-08-14 16:51:38.291',NULL),
    (242,'','修改数据','app-group-fill','','/0/2/59/242','F','','admin:sysDictData:edit',59,0,'','',0,'0','1',1,1,'2020-04-11 15:52:48.000','2024-08-14 16:51:38.292',NULL),
    (243,'','删除数据','app-group-fill','','/0/2/59/243','F','','admin:sysDictData:remove',59,0,'','',0,'0','1',1,1,'2020-04-11 15:52:48.000','2024-08-14 16:51:38.292',NULL),
    (244,'','查询参数','app-group-fill','','/0/2/62/244','F','','admin:sysConfig:query',62,0,'','',0,'0','1',1,1,'2020-04-11 15:52:48.000','2024-07-08 16:15:45.737',NULL),
    (245,'','新增参数','app-group-fill','','/0/2/62/245','F','','admin:sysConfig:add',62,0,'','',0,'0','1',1,1,'2020-04-11 15:52:48.000','2024-07-08 16:15:45.737',NULL),
    (246,'','修改参数','app-group-fill','','/0/2/62/246','F','','admin:sysConfig:edit',62,0,'','',0,'0','1',1,1,'2020-04-11 15:52:48.000','2024-07-08 16:15:45.738',NULL),
    (247,'','删除参数','app-group-fill','','/0/2/62/247','F','','admin:sysConfig:remove',62,0,'','',0,'0','1',1,1,'2020-04-11 15:52:48.000','2024-07-08 16:15:45.738',NULL),
    (248,'','查询登录日志','app-group-fill','','/0/2/211/212/248','F','','admin:sysLoginLog:query',212,0,'','',0,'0','1',1,1,'2020-04-11 15:52:48.000','2024-07-08 16:15:45.739',NULL),
    (249,'','删除登录日志','app-group-fill','','/0/2/211/212/249','F','','admin:sysLoginLog:remove',212,0,'','',0,'0','1',1,1,'2020-04-11 15:52:48.000','2024-07-08 16:15:45.740',NULL),
    (250,'','查询操作日志','app-group-fill','','/0/2/211/216/250','F','','admin:sysOperLog:query',216,0,'','',0,'0','1',1,1,'2020-04-11 15:52:48.000','2024-07-08 16:15:45.740',NULL),
    (251,'','删除操作日志','app-group-fill','','/0/2/211/216/251','F','','admin:sysOperLog:remove',216,0,'','',0,'0','1',1,1,'2020-04-11 15:52:48.000','2024-07-08 16:15:45.741',NULL),
    (261,'Gen','代码生成','code','/dev-tools/gen','/0/60/261','C','','',60,0,'','/dev-tools/gen/index',2,'0','1',1,1,'2020-04-11 15:52:48.000','2024-07-08 16:15:45.736',NULL),
    (262,'EditTable','代码生成修改','build','/dev-tools/editTable','/0/60/262','C','','',60,0,'','/dev-tools/gen/editTable',100,'1','1',1,1,'2020-04-11 15:52:48.000','2024-07-08 16:15:45.736',NULL),
    (264,'Build','表单构建','build','/dev-tools/build','/0/60/264','C','','',60,0,'','/dev-tools/build/index',1,'0','1',1,1,'2020-04-11 15:52:48.000','2024-07-08 16:15:45.736',NULL),
    (269,'ServerMonitor','服务监控','druid','/sys-tools/monitor','/0/537/269','C','','sysTools:serverMonitor:list',537,0,'','/sys-tools/monitor',0,'0','1',1,1,'2020-04-14 00:28:19.000','2024-09-29 17:39:23.380',NULL),
    (459,'Schedule','定时任务','time-range','/schedule','/0/459','M','无','',0,0,'','Layout',20,'0','1',1,1,'2020-08-03 09:17:37.000','2024-09-29 17:39:23.380',NULL),
    (460,'ScheduleManage','定时任务','job','/schedule/manage','/0/459/460','C','无','job:sysJob:list',459,0,'','/schedule/index',0,'0','1',1,1,'2020-08-03 09:17:37.000','2024-09-29 17:39:23.380',NULL),
    (461,'sys_job','分页获取定时任务','app-group-fill','','/0/459/460/461','F','无','job:sysJob:query',460,0,'','',0,'0','1',1,1,'2020-08-03 09:17:37.000','2024-09-29 17:39:23.380',NULL),
    (462,'sys_job','创建定时任务','app-group-fill','','/0/459/460/462','F','无','job:sysJob:add',460,0,'','',0,'0','1',1,1,'2020-08-03 09:17:37.000','2024-09-29 17:39:23.380',NULL),
    (463,'sys_job','修改定时任务','app-group-fill','','/0/459/460/463','F','无','job:sysJob:edit',460,0,'','',0,'0','1',1,1,'2020-08-03 09:17:37.000','2024-09-29 17:39:23.380',NULL),
    (464,'sys_job','删除定时任务','app-group-fill','','/0/459/460/464','F','无','job:sysJob:remove',460,0,'','',0,'0','1',1,1,'2020-08-03 09:17:37.000','2024-09-29 17:39:23.380',NULL),
    (471,'JobLog','日志','bug','/schedule/log','/0/459/471','C','','',459,0,'','/schedule/log',0,'1','1',1,1,'2020-08-05 21:24:46.000','2024-09-29 17:39:23.380',NULL),
    (528,'SysApiManage','接口管理','api-doc','/admin/sys-api','/0/2/528','C','无','admin:sysApi:list',2,0,'','/admin/sys-api/index',0,'0','0',0,1,'2021-05-20 22:08:44.526','2024-07-09 11:50:31.084',NULL),
    (529,'','查询接口','app-group-fill','','/0/2/528/529','F','无','admin:sysApi:query',528,0,'','',40,'0','0',0,1,'2021-05-20 22:08:44.526','2024-07-09 11:50:31.087',NULL),
    (531,'','修改接口','app-group-fill','','/0/2/528/531','F','无','admin:sysApi:edit',528,0,'','',30,'0','0',0,1,'2021-05-20 22:08:44.526','2024-07-09 11:50:31.091',NULL),
    (537,'SysTools','系统工具','system-tools','/sys-tools','/0/537','M','','',0,0,'','Layout',30,'0','1',1,1,'2021-05-21 11:13:32.166','2024-09-29 17:39:23.380',NULL),
    (540,'SysConfigSet','参数设置','system-tools','/admin/sys-config/set','/0/2/540','C','','admin:sysConfigSet:list',2,0,'','/admin/sys-config/set',0,'0','1',1,1,'2021-05-25 16:06:52.560','2024-07-08 16:15:45.721',NULL),
    (542,'','修改','upload','','/0/2/540/542','F','','admin:sysConfigSet:update',540,0,'','',0,'0','1',1,1,'2021-06-13 11:45:48.670','2024-07-08 16:15:45.745',NULL),
    (543,'OrderCenter','工单中心','education','/orderCenter','/0/543','M','','',0,0,'','Layout',1,'0','1',1,1,'2024-07-09 11:42:28.535','2024-09-29 17:39:23.380',NULL),
    (544,'OrderApply','工单申请','json-push','/orderCenter/apply','/0/543/544','C','','',543,0,'','/orderCenter/index',0,'0','0',1,1,'2024-07-09 11:50:54.940','2024-09-29 17:39:23.380',NULL),
    (545,'OrderList','工单列表','base-info','/orderCenter/list','/0/543/545','C','','',543,0,'','/orderCenter/list/workOrderList',1,'0','1',1,1,'2024-07-09 11:56:50.887','2024-09-29 17:39:23.380',NULL),
    (546,'WorkOrderDetails','工单详情','','/orderCenter/workflow/work-order/details/:id/:title','/0/543/546','C','','general:orderWorks:details',543,0,'','/orderCenter/list/workOrderDetails',3,'1','1',1,1,'2024-07-09 11:58:32.874','2024-09-29 17:39:23.380',NULL),
    (547,'FormRender','表单提交','clipboard','/order/classify/:bindTempLate','/0/543/547','C','','',543,0,'','/orderCenter/list/formRender',4,'1','1',1,1,'2024-07-09 12:00:13.000','2024-09-29 17:39:23.380',NULL),
    (548,'flowCenter','流程中心','app-group-fill','/flowCenter','/0/548','M','','',0,0,'','Layout',2,'0','1',1,1,'2024-07-09 12:03:07.870','2024-08-14 20:21:50.970',NULL),
    (549,'OrderCateGory','工单类型','log','/flowCenter/order-category','/0/548/549','C','','',548,0,'','/flowCenter/orderCateGory',0,'0','1',1,1,'2024-07-09 12:04:55.000','2024-10-09 15:54:50.150',NULL),
    (550,'TemplateManage','模板管理','dict','/flowCenter/template-manage','/0/548/550','C','','',548,0,'','/flowCenter/templateManage',2,'0','1',1,1,'2024-07-09 12:06:10.000','2024-10-09 15:55:21.015',NULL),
    (551,'OrderManage','工单管理','row','/flowCenter/order-manage','/0/548/551','C','','',548,0,'','/flowCenter/orderManage',3,'0','1',1,1,'2024-07-09 12:19:39.000','2024-10-09 15:55:28.842',NULL),
    (552,'FlowManage','流程管理','operators','/flowCenter/flow-manage','/0/548/552','C','','',548,0,'','/flowCenter/flowManage',1,'0','1',1,1,'2024-07-09 12:21:22.000','2024-10-09 15:55:11.043',NULL),
    (553,'TaskCenter','任务中心','example','/task','/0/553','M','','',0,0,'','Layout',3,'0','1',1,1,'2024-07-09 12:24:37.821','2024-09-29 17:39:23.380',NULL),
    (554,'TaskList','任务列表','list','/taskCenter/list','/0/553/554','C','','general:orderTask:list',553,0,'','/taskCenter/index',0,'0','1',1,1,'2024-07-09 12:26:49.198','2024-09-29 17:39:23.380',NULL),
    (555,'TaskHistory','历史任务','project-manage','/taskCenter/history','/0/553/555','C','','',553,0,'','/taskCenter/history',1,'0','1',1,1,'2024-07-09 12:28:39.180','2024-10-09 15:56:32.343',NULL),
    (556,'TaskExecute','执行节点','access','/taskCenter/execMachine','/0/553/556','C','','',553,0,'','/taskCenter/execMachine',2,'0','1',1,1,'2024-07-09 12:29:44.818','2024-10-09 15:57:00.883',NULL),
    (569,'','提交工单','app-group-fill','','/0/543/547/569','F','','general:orderApply:add',547,0,'','',1,'0','1',1,1,'2024-08-13 14:55:55.057','2024-09-29 17:39:23.380',NULL),
    ...
    (571,'','我的待办','app-group-fill','','/0/543/545/571','F','','general:orderWorks:myBacklog',545,0,'','',10,'0','1',1,1,'2024-08-13 15:57:01.071','2024-09-29 17:39:23.380',NULL),
    (572,'','我创建的','app-group-fill','','/0/543/545/572','F','','general:orderWorks:createdByMe',545,0,'','',20,'0','1',1,1,'2024-08-13 15:57:46.963','2024-09-29 17:39:23.380',NULL),
    (573,'','我相关的','app-group-fill','','/0/543/545/573','F','','general:orderWorks:relatedToMe',545,0,'','',30,'0','1',1,1,'2024-08-13 15:58:41.259','2024-09-29 17:39:23.380',NULL),
    (574,'','工单处理','app-group-fill','','/0/543/546/574','F','','general:orderWorks:handler',546,0,'','',10,'0','1',1,1,'2024-08-13 16:01:47.417','2024-09-29 17:39:23.380',NULL),
    ...
    (576,'','获取工单类型','app-group-fill','','/0/543/544/576','F','','general:orderCategory:list',544,0,'','',0,'0','1',1,1,'2024-08-13 19:37:16.887','2024-09-29 17:39:23.380',NULL),
    (577,'','获取工单项','app-group-fill','','/0/543/544/577','F','','general:orderItems:list',544,0,'','',0,'0','1',1,1,'2024-08-13 19:38:46.741','2024-09-29 17:39:23.380',NULL),
    (578,'','获取指定的工单数据','app-group-fill','','/0/543/545/578','F','','general:orderWorks:listid',545,0,'','',2,'0','1',1,1,'2024-08-13 20:02:37.576','2024-09-29 17:39:23.380',NULL),
    (579,'','工单更新','app-group-fill','','/0/543/545/579','F','','general:orderWorks:update',545,0,'','',3,'0','1',1,1,'2024-08-13 20:07:11.853','2024-09-29 17:39:23.380',NULL),
    (580,'','类型列表','app-group-fill','','/0/548/549/580','F','','general:orderCategory:list',549,0,'','',10,'0','1',1,1,'2024-08-13 20:12:45.390','2024-10-09 15:54:50.150',NULL),
    (581,'','新建工单分类','app-group-fill','','/0/548/549/581','F','','general:orderCategory:create',549,0,'','',20,'0','1',1,1,'2024-08-13 20:14:57.885','2024-10-09 15:54:50.151',NULL),
    (582,'','更新工单分类','app-group-fill','','/0/548/549/582','F','','general:orderCategory:update',549,0,'','',50,'0','1',1,1,'2024-08-13 20:15:18.734','2024-10-09 15:54:50.151',NULL),
    (583,'','删除工单分类','app-group-fill','','/0/548/549/583','F','','general:orderCategory:delete',549,0,'','',40,'0','1',1,1,'2024-08-13 20:15:44.973','2024-10-09 15:54:50.151',NULL),
    (584,'','根据id查询工单分类','app-group-fill','','/0/548/549/584','F','','general:orderCategory:listId',549,0,'','',30,'0','1',1,1,'2024-08-13 20:16:18.138','2024-10-09 15:54:50.152',NULL),
    (585,'','流程列表','app-group-fill','','/0/548/552/585','F','','general:orderFlowManage:list',552,0,'','',10,'0','1',1,1,'2024-08-13 20:34:36.752','2024-10-09 15:55:11.044',NULL),
    (586,'','新建流程','app-group-fill','','/0/548/552/586','F','','general:orderFlowManage:create',552,0,'','',20,'0','1',1,1,'2024-08-13 20:35:05.574','2024-10-09 15:55:11.049',NULL),
    (587,'','更新流程','app-group-fill','','/0/548/552/587','F','','general:orderFlowManage:update',552,0,'','',30,'0','1',1,1,'2024-08-13 20:35:32.835','2024-10-09 15:55:11.049',NULL),
    (588,'','删除流程','app-group-fill','','/0/548/552/588','F','','general:orderFlowManage:delete',552,0,'','',40,'0','1',1,1,'2024-08-13 20:36:00.732','2024-10-09 15:55:11.050',NULL),
    (589,'','克隆流程','app-group-fill','','/0/548/552/589','F','','general:orderFlowManage:clone',552,0,'','',50,'0','1',1,1,'2024-08-13 20:36:16.508','2024-10-09 15:55:11.052',NULL),
    (590,'','根据id查询流程','','','/0/548/552/590','F','','general:orderFlowManage:listId',552,0,'','',70,'0','1',1,1,'2024-08-13 20:36:48.647','2024-10-09 15:55:11.053',NULL),
    (591,'','模板列表','app-group-fill','','/0/548/550/591','F','','general:orderTemplate:list',550,0,'','',10,'0','1',1,1,'2024-08-13 20:37:38.658','2024-10-09 15:55:21.015',NULL),
    (592,'','创建模板','app-group-fill','','/0/548/550/592','F','','general:orderTemplate:create',550,0,'','',20,'0','1',1,1,'2024-08-13 20:38:16.755','2024-10-09 15:55:21.016',NULL),
    (593,'','更新模板','app-group-fill','','/0/548/550/593','F','','general:orderTemplate:update',550,0,'','',30,'0','1',1,1,'2024-08-13 20:38:42.278','2024-10-09 15:55:21.016',NULL),
    (594,'','删除模板','app-group-fill','','/0/548/550/594','F','','general:orderTemplate:delete',550,0,'','',50,'0','1',1,1,'2024-08-13 20:39:01.732','2024-10-09 15:55:21.017',NULL),
    (595,'','根据id查询模板','app-group-fill','','/0/548/550/595','F','','general:orderTemplate:listId',550,0,'','',50,'0','1',1,1,'2024-08-13 20:39:31.285','2024-10-09 15:55:21.017',NULL),
    (596,'','工单列表','app-group-fill','','/0/548/551/596','F','','general:orderItems:list',551,0,'','',10,'0','1',1,1,'2024-08-13 20:41:17.251','2024-10-09 15:55:28.843',NULL),
    (597,'','创建工单项','app-group-fill','','/0/548/551/597','F','','general:orderItems:create',551,0,'','',20,'0','1',1,1,'2024-08-13 20:42:31.063','2024-10-09 15:55:28.843',NULL),
    ...
    (600,'','根据id查询工单项','app-group-fill','','/0/548/550/600','F','','general:orderItems:listId',550,0,'','',50,'0','1',1,1,'2024-08-13 20:44:48.263','2024-10-09 15:55:21.017',NULL),
    (601,'','获取模板','app-group-fill','','/0/548/551/601','F','','general:orderTemplate:list',551,0,'','',50,'0','1',1,1,'2024-08-13 21:04:51.547','2024-10-09 15:55:28.844',NULL),
    (602,'','工单消息通知','app-group-fill','','/0/543/602','F','','general:orderNotify:list',543,0,'','',5,'0','1',1,1,'2024-08-14 16:27:19.613','2024-09-29 17:39:23.380',NULL),
    (603,'','获取工单列表','app-group-fill','','/0/543/545/603','F','','general:orderWorks:list',545,0,'','',1,'0','1',1,1,'2024-08-14 16:53:29.195','2024-09-29 17:39:23.380',NULL),
    (604,'','获取工单历史记录','api-monitor','','/0/543/546/604','F','','general:orderWorks:historyGet',546,0,'','',20,'0','1',1,1,'2024-08-14 16:56:28.348','2024-09-29 17:39:23.380',NULL),
    (605,'','部门列表','app-group-fill','','/0/548/552/605','F','','general:orderDept:list',552,0,'','',80,'0','1',1,0,'2024-08-14 19:35:10.803','2024-10-09 15:55:11.053',NULL),
    (606,'','用户列表','app-group-fill','','/0/548/552/606','F','','general:orderUser:list',552,0,'','',90,'0','1',1,0,'2024-08-14 19:36:15.750','2024-10-09 15:55:11.054',NULL),
    (607,'','权限列表','app-group-fill','','/0/548/552/607','F','','general:orderRole:list',552,0,'','',60,'0','1',1,0,'2024-08-14 19:37:31.487','2024-10-09 15:55:11.055',NULL),
    (608,'','查看工单','app-group-fill','','/0/543/545/608','F','','general:orderWorks:view',545,0,'','',0,'0','1',1,1,'2024-08-14 19:56:37.397','2024-09-29 17:39:23.380',NULL),
    (609,'','获取用户列表','app-group-fill','','/0/543/545/609','F','','general:orderWorks:getUsers',545,0,'','',40,'0','1',1,1,'2024-08-17 17:08:28.627','2024-09-29 17:39:23.380',NULL),
    (610,'','创建任务','app-group-fill','','/0/553/554/610','F','','general:orderTask:create',554,0,'','',1,'0','1',1,1,'2024-08-17 20:51:15.230','2024-09-29 17:39:23.380',NULL),
    (611,'','更新任务','app-group-fill','','/0/553/554/611','F','','general:orderTask:update',554,0,'','',2,'0','1',1,1,'2024-08-17 20:52:31.690','2024-09-29 17:39:23.380',NULL),
    ...
    (613,'','根据id查询任务','app-group-fill','','/0/553/554/613','F','','general:orderTask:listId',554,0,'','',3,'0','1',1,1,'2024-08-17 20:53:41.157','2024-09-29 17:39:23.380',NULL),
    (614,'','删除任务','app-group-fill','','/0/553/554/614','F','','general:orderTask:delete',554,0,'','',4,'0','1',1,1,'2024-08-17 20:54:13.565','2024-09-29 17:39:23.380',NULL),
    ...
    (617,'','分页获取ExecMachine','','exec_machine','/0/615/616/617','F','无','admin:execMachine:query',616,0,'','',0,'0','0',1,1,'2024-09-01 23:33:35.498','2024-09-01 23:33:35.500',NULL),
    (618,'','创建ExecMachine','','exec_machine','/0/615/616/618','F','无','admin:execMachine:add',616,0,'','',0,'0','0',1,1,'2024-09-01 23:33:35.501','2024-09-01 23:33:35.502',NULL),
    (619,'','修改ExecMachine','','exec_machine','/0/615/616/619','F','无','admin:execMachine:edit',616,0,'','',0,'0','0',1,1,'2024-09-01 23:33:35.503','2024-09-01 23:33:35.505',NULL),
    (620,'','删除ExecMachine','','exec_machine','/0/615/616/620','F','无','admin:execMachine:remove',616,0,'','',0,'0','0',1,1,'2024-09-01 23:33:35.506','2024-09-01 23:33:35.508',NULL),
    ...
    (623,'','分页获取ExecMachine','','exec_machine','/0/621/622/623','F','无','admin:execMachine:query',622,0,'','',0,'0','0',1,1,'2024-09-01 23:34:34.180','2024-09-01 23:34:34.182',NULL),
    (624,'','创建ExecMachine','','exec_machine','/0/621/622/624','F','无','admin:execMachine:add',622,0,'','',0,'0','0',1,1,'2024-09-01 23:34:34.185','2024-09-01 23:34:34.187',NULL),
    (625,'','修改ExecMachine','','exec_machine','/0/621/622/625','F','无','admin:execMachine:edit',622,0,'','',0,'0','0',1,1,'2024-09-01 23:34:34.190','2024-09-01 23:34:34.192',NULL),
    (626,'','删除ExecMachine','','exec_machine','/0/621/622/626','F','无','admin:execMachine:remove',622,0,'','',0,'0','0',1,1,'2024-09-01 23:34:34.195','2024-09-01 23:34:34.196',NULL),
    (627,'','工单评价','app-group-fill','','/0/543/546/627','F','','general:orderRating:rating',546,0,'','',30,'0','1',1,1,'2024-09-23 20:41:04.810','2024-09-29 17:39:23.380',NULL),
    (628,'','工单留言','app-group-fill','','/0/543/546/628','F','','general:orderComment:comment',546,0,'','',40,'0','1',1,1,'2024-09-23 20:42:44.303','2024-09-29 17:39:23.380',NULL);
...
VALUES
    (1,1,2,1,0,'2024-10-09 15:47:54.954','2024-10-09 15:47:54.954',NULL);
