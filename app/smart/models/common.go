...
type OperationHistory struct {
	...
	HandleTime     models.JSONTime `gorm:"column:handleTime" json:"handleTime"`                     // 处理时间
...
type WorksNotify struct {
	...
	CurrentHandler string `gorm:"column:currentHandler;type:varchar(50)" json:"currentHandler"`
